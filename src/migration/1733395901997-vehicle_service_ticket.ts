...
export class VehicleServiceTicket1733395901997 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_ticket" ADD CONSTRAINT "FK_f55b83f763efe2c429c5987c47b" FOREIGN KEY ("vehicle_id") REFERENCES "vehicle"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
