...
export class EntityHotlistingStatusAttAdded1735544709777 implements MigrationInterface {
    name = 'EntityHotlistingStatusAttAdded1735544709777'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "isActive"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "attributeName"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "attributeValue"`);
        await queryRunner.query(`ALTER TABLE "role" ADD "status" boolean DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "user" ADD "status" boolean DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "firmware_management" ADD "status" boolean DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "attribute_name" character varying(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "attribute_value" character varying(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "is_active" boolean NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "parameter_pid" DROP CONSTRAINT "FK_f3cc4d1b98879c5f935bbe52576"`);
        await queryRunner.query(`ALTER TABLE "parameter_pid" DROP CONSTRAINT "FK_6bd37757d1cd557bcbf985dd3e5"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "is_active"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "attribute_value"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" DROP COLUMN "attribute_name"`);
        await queryRunner.query(`ALTER TABLE "firmware_management" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "role" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "attributeValue" character varying(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "attributeName" character varying(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "ecu_attributes" ADD "isActive" boolean NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_dtc_dataset" ADD CONSTRAINT "FK_bc92530a3bb4ba6548f5ccbc87c" FOREIGN KEY ("dtc_dataset_id") REFERENCES "dtc_dataset"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ecu_dtc_dataset" ADD CONSTRAINT "FK_d19b1857794dac857a9e29b47d9" FOREIGN KEY ("ecu_id") REFERENCES "ecu_management"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ecu_pid_dataset" ADD CONSTRAINT "FK_9642825b253339f1dd096c5e257" FOREIGN KEY ("pid_dataset_id") REFERENCES "pid_dataset"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ecu_pid_dataset" ADD CONSTRAINT "FK_f26846ba382cf13481c0686c08c" FOREIGN KEY ("ecu_id") REFERENCES "ecu_management"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
