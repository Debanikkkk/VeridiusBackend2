...
export class VehiclePartsChanging1735721958595 implements MigrationInterface {
    name = 'VehiclePartsChanging1735721958595'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" DROP COLUMN "replaced_by"`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" ADD "replaced_at" TIMESTAMP DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" ADD "technician_id" integer`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" ADD CONSTRAINT "FK_86efaf53485976ff6c4fa6d5298" FOREIGN KEY ("technician_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "parameter_pid" DROP CONSTRAINT "FK_f3cc4d1b98879c5f935bbe52576"`);
        await queryRunner.query(`ALTER TABLE "parameter_pid" DROP CONSTRAINT "FK_6bd37757d1cd557bcbf985dd3e5"`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" DROP CONSTRAINT "FK_86efaf53485976ff6c4fa6d5298"`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" DROP COLUMN "technician_id"`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" DROP COLUMN "replaced_at"`);
        await queryRunner.query(`ALTER TABLE "vehicle_parts_replacement" ADD "replaced_by" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ecu_dtc_dataset" ADD CONSTRAINT "FK_bc92530a3bb4ba6548f5ccbc87c" FOREIGN KEY ("dtc_dataset_id") REFERENCES "dtc_dataset"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ecu_dtc_dataset" ADD CONSTRAINT "FK_d19b1857794dac857a9e29b47d9" FOREIGN KEY ("ecu_id") REFERENCES "ecu_management"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ecu_pid_dataset" ADD CONSTRAINT "FK_9642825b253339f1dd096c5e257" FOREIGN KEY ("pid_dataset_id") REFERENCES "pid_dataset"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ecu_pid_dataset" ADD CONSTRAINT "FK_f26846ba382cf13481c0686c08c" FOREIGN KEY ("ecu_id") REFERENCES "ecu_management"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
