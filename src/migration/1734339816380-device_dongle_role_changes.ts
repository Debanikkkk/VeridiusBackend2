...
export class DeviceDongleRoleChanges1734339816380 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "device" ADD COLUMN IF NOT EXISTS "imei" character varying;`);

    await queryRunner.query(`ALTER TABLE "device" ADD CONSTRAINT "UQ_82f62b91e2fcf2a44cf859cbfd1" UNIQUE ("imei")`);
    await queryRunner.query(`ALTER TABLE "device" ADD COLUMN IF NOT EXISTS "dongle_conn_status" boolean DEFAULT true`);
    ...
    await queryRunner.query(
      `ALTER TABLE "role" ADD CONSTRAINT "FK_04a09925beea59e864e921db4a1" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
