...
export class VehicleManDateNumberToDate1734600579975 implements MigrationInterface {
    name = 'VehicleManDateNumberToDate1734600579975'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vehicle" ADD "manufacture_year" TIMESTAMP NOT NULL`);
