...
export class FileFirmwareCascade1734962068670 implements MigrationInterface {
    name = 'FileFirmwareCascade1734962068670'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "file" ADD CONSTRAINT "FK_7f1b4e823d48a864ba999832ad2" FOREIGN KEY ("firmware_id") REFERENCES "firmware_management"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
