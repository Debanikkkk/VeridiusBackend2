...
export class EcuController extends Controller {
  ...
  public async saveECU(@Body() req: ReqECU): Promise<ResECU> {
    ...
    const resEcu: ResECU = {
      ...
      firmwares: {
        // created_by: saveECU.firmware?.created_by,
        // files: saveECU.firmware?.,
        firmwareType: saveECU.firmware?.firmware_type,
        firmwareVersion: saveECU.firmware?.firmware_version,
        id: saveECU.firmware?.id,
      },
      //   vehicles,
