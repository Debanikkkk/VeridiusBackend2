...
exports.AddedBlogThumbnail1719999705026 = void 0;
class AddedBlogThumbnail1719999705026 {
    constructor() {
        this.name = 'AddedBlogThumbnail1719999705026';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "blog_n_tags" DROP CONSTRAINT "FK_08b6bc95f1e1260feebede63b8b"`);
        await queryRunner.query(`ALTER TABLE "blog" ADD "blog_thumbnail" character varying(1024)`);
    ...
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "blog_n_tags" DROP CONSTRAINT "FK_08b6bc95f1e1260feebede63b8b"`);
        await queryRunner.query(`ALTER TABLE "blog" DROP COLUMN "blog_thumbnail"`);
...
exports.AddedBlogThumbnail1719999705026 = AddedBlogThumbnail1719999705026;
//# sourceMappingURL=1719999705026-added_blog_thumbnail.js.map